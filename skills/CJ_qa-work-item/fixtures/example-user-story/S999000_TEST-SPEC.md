...
<!-- Synthetic fixture for /CJ_qa-work-item v1 manual testing. The expected
...
|---|-----|-----|-------|-------------------|----------------|
| S1 | core | AC-2 | fixture-impl.txt exists | File presence | `test -f skills/CJ_qa-work-item/fixtures/example-user-story/fixture-impl.txt` |
| S2 | core | AC-2 | fixture-impl.txt is non-empty | File non-emptiness | `test -s skills/CJ_qa-work-item/fixtures/example-user-story/fixture-impl.txt` |

## E2E Tests

| # | Tag | AC | Scenario | Steps (as a real user would) | Expected Outcome | Rubric |
|---|-----|-----|----------|------------------------------|------------------|--------|
| E1 | core | AC-1 | Exact content match | 1. Read `skills/CJ_qa-work-item/fixtures/example-user-story/fixture-impl.txt`. 2. Compare its content (after stripping a single trailing newline if present) to the literal string `Hello, World!`. | The file contents equal `Hello, World!` exactly (capital W, exclamation point) | PASS if exact match; FAIL on any byte difference, including case and punctuation |
