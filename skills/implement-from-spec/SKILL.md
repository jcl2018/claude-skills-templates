...
```
/implement-from-spec <work-item-dir>
/implement-from-spec <work-item-dir> --auto
```
...
/implement-from-spec work-items/defects/personal-workflow/D000016_test_deploy_stale_templates

# task (new path; reads TRACKER + test-plan)
/implement-from-spec work-items/tasks/personal-workflow/T000005_some_task

# feature (delegates to a child user-story via AUQ)
/implement-from-spec work-items/features/personal-workflow/F000012_pipeline_parity
```
...
| Required input artifact missing | "Error: {artifact}.md not found in {dir} (required for type {type})" | Run `/scaffold-work-item` first; or fill the missing artifact manually |
