...
<!-- Synthetic test plan for /implement-from-spec defect-path fixture.
...
|---|-----------|-------|-----------------|--------|
| 1 | File exists post-fix | After `/implement-from-spec` runs on this fixture, check that `skills/implement-from-spec/fixtures/example-defect/output/fixed.txt` exists | File exists | Pending |
...
- [ ] After dogfood, run `/personal-workflow check skills/implement-from-spec/fixtures/example-defect/` — should be PASS (or warn-only)
