...
```bash
# Reset state
rm -f skills/implement-from-spec/fixtures/example-defect/output/fixed.txt

# Run the skill (default mode: propose-and-confirm)
/implement-from-spec skills/implement-from-spec/fixtures/example-defect/

# Or run with --auto
/implement-from-spec skills/implement-from-spec/fixtures/example-defect/ --auto
```
...
11. **Step 11 boundary check at end:** PASSES — TRACKER structure compliant after writes
12. **Step 12 print summary:** `IMPLEMENT COMPLETE: D888000` block + `Next: /qa-work-item ...`
...
```bash
rm -f skills/implement-from-spec/fixtures/example-defect/output/fixed.txt
git checkout -- skills/implement-from-spec/fixtures/example-defect/D888000_TRACKER.md
```
