...
A trivial "produce a greeting file" user-story exists solely to give /qa-work-item something to QA. The implementation has a planted bug so the QA engineer subagent has a known-red criterion to find.
...
- `/qa-work-item skills/qa-work-item/fixtures/example-user-story/` returns smoke green + E2E red, with the red finding naming the content mismatch.
...
- `../../../../skills/qa-work-item/qa.md` Step 7 for the subagent contract
