...
# Should print: **Status: SCAFFOLDED → `work-items/features/CJ_personal-workflow/F000010_pipeline_skills/` on ...**
# Verify the work-item dir exists
ls work-items/features/CJ_personal-workflow/F000010_pipeline_skills/
...
before /CJ_scaffold-work-item shipped Step 12). Use F000014's design doc instead
(it has the footer):
