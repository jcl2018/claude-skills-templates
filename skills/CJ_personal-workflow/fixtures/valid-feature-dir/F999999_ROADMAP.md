...
Test feature for the CJ_personal-workflow validator's directory-mode fixture. Demonstrates the canonical v3 3-artifact set (TRACKER + DESIGN + ROADMAP) that should pass `/CJ_personal-workflow check <dir>` cleanly.
