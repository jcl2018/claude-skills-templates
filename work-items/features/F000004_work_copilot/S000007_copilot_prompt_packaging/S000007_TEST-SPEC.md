...
|---|-----|-----------|-----|-------------|-------|-----------------|----------|------|
| 1 | core | Valid feature dir returns all PASS | AC-1 | feature dir with TRACKER.md + milestones.md, both valid | Run `/validate work-items/features/F000004_work_copilot/` | `[PASS] TRACKER.md`, `[PASS] milestones.md`, `Summary: 2 PASS, 0 MISSING, 0 DRIFT` | P0 | E2E |
...
|---|-----|----------|----------------------------|-----------------|--------|
| E1 | core | Fresh install validates a known-good item | 1. Install bundle in a fresh repo. 2. Copy F000004 work-item into it. 3. Open Copilot chat. 4. Type `/validate work-items/features/F000004_work_copilot/` | All PASS; summary footer shows 2 PASS | Pass if every line matches expected contract |
