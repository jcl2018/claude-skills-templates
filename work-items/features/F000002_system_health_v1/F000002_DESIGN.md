---
type: design
parent: F000002_system_health_v1
title: "system-health-v1 — Feature Design"
version: 1
status: Backfill
date: 2026-04-22
author: chjiang
...
See [F000002_TRACKER.md](F000002_TRACKER.md) Log/Insights. system-health-v1 delivered the `~/.claude/` health dashboard skill — dependency graph, filesystem health checks, usage analytics, and a composite health score.
...
- Milestones: [F000002_milestones.md](F000002_milestones.md)
