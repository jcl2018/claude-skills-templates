...
|---|-----|-----------|-----|-------------|-------|-----------------|----------|------|
| 1 | core | Ambient awareness for scaffolding question | AC-1 | instructions installed, Copilot chat open | Ask "how do I add a user story under F000005?" | Response references `work-items/features/F000005_*/S0000NN_*/` with correct parent and required artifacts | P0 | E2E |
