...
title: "workflow-alpha — Feature Design"
version: 1
status: Backfill
date: 2026-04-22
author: chjiang
...
See [F000001_TRACKER.md](F000001_TRACKER.md) Log/Insights. workflow-alpha was the founding feature of this workbench: it established the personal-dev work item standard, the 3-phase lifecycle, and the scaffolding conventions now used across every feature.
