...
- [ ] CI fails on Windows regression
- [ ] README "Running on Windows" section
...
- [ ] add windows-latest job (Git Bash) running the portable-date + copy-mode-install subset
- [ ] write README "Running on Windows"
- [ ] add CLAUDE.md note
- [ ] (optional) skills-deploy doctor platform line
