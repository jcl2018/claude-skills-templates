/personal-workflow check work-items/tasks/T000099_broken/
...
Run the standard `/personal-workflow check` validation on this task directory. Then output a JSON object summarizing what you found, matching exactly this shape:
