/personal-workflow check work-items/features/F999002_drift/F999002_TRACKER.md
...
Run the standard `/personal-workflow check` validation in **File Mode** on this tracker (Steps 2–7 of `check.md`). Step 6.5 (Check Lifecycle) compares phase headers and counts gate checkboxes against the template-derived `min_checkboxes`.
