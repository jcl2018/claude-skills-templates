/CJ_personal-workflow check work-items/features/F999999_test_feature/
...
Run the standard `/CJ_personal-workflow check` directory-mode validation on this feature directory (Tier 1 Directory Mode — Steps 8 through 13 of `check.md`).
