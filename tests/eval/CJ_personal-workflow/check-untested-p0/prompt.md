/CJ_personal-workflow check work-items/features/F999003_untested/S999003_two_p0/
...
Apply Step 18 (Cross-Reference Traceability) of `/CJ_personal-workflow check`. For each P0 story #n in SPEC, check whether the literal `AC-<n>` is in `ac_set`. If not, flag the story as `[UNTESTED]`.
