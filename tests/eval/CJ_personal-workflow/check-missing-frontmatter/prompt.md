/CJ_personal-workflow check work-items/features/F999001_broken/F999001_TRACKER.md
...
Run the standard `/CJ_personal-workflow check` validation in **File Mode** (Steps 2–7 of `check.md`) on this tracker file. Step 5 (Check Frontmatter) compares the instance's frontmatter keys against `required_fields` derived from the template; missing fields produce VIOLATIONs.
