...
| `docs/tests/workflow/goal-task-eval.md` | SEEDED per-test doc for the `goal-task-eval` workflow-category test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/workflow/e2e-local.md` | SEEDED per-test doc for the `e2e-local` workflow-category test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page (or explains why none applies); seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI-push/validate.md` | SEEDED per-test doc for the `validate` CI-push-category test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI-push/suite.md` | SEEDED per-test doc for the `suite` CI-push-category test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI-push/test-deploy.md` | SEEDED per-test doc for the `test-deploy` CI-push-category test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI-push/windows.md` | SEEDED per-test doc for the `windows` CI-push-category test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI-nightly/windows-deploy.md` | SEEDED per-test doc for the `windows-deploy` CI-nightly-category test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
