...
| `docs/tests/infra/CI-push/test-deploy.md` | SEEDED per-test doc for the `test-deploy` infra-category CI-push-layer test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the two-axis categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/workflow/CI-push/portability-smoke.md` | SEEDED per-test doc for the `portability-smoke` workflow-category CI-push-layer test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the two-axis categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/workflow/CI-nightly/portability-deploy.md` | SEEDED per-test doc for the `portability-deploy` workflow-category CI-nightly-layer test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the two-axis categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/workflow/CI-nightly/goal-task-eval.md` | SEEDED per-test doc for the `goal-task-eval` workflow-category CI-nightly-layer test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the two-axis categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/workflow/CI-nightly/goal-feature-eval.md` | SEEDED per-test doc for the `goal-feature-eval` workflow-category CI-nightly-layer test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the two-axis categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/workflow/CI-nightly/doc-sync.md` | SEEDED per-test doc for the `doc-sync` workflow-category CI-nightly-layer test — the authoritative What/How/Why front door for one declared category test. Seeded by /CJ_test_audit from the two-axis categories: axis (idempotent; safe to edit). | Present; carries the three front-door sections `## What it is` / `## How to run` / `## Explanation` (test-spec.sh --check-structure check (f)), cross-links its docs/tests/<family>.md units-detail page; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
