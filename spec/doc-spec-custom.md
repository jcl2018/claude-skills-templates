...
| `docs/workflows/utility-audits.md` | GENERATED standalone read-only utility audits — /CJ_portability-audit (the authoritative correct-behavior spec), /CJ_doc_audit, /CJ_test_audit; rendered from spec/workflow-spec.md. | Present; generated (do-not-edit banner); byte-matches a fresh render (validate.sh Check 27); human-readable; no work-item IDs. |
...
| `docs/tests/workflow/goal-task-eval.md` | SEEDED per-test doc for the `goal-task-eval` workflow-category test — one doc per declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/workflow/e2e-local.md` | SEEDED per-test doc for the `e2e-local` workflow-category test — one doc per declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI-push/validate.md` | SEEDED per-test doc for the `validate` CI-push-category test — one doc per declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI-push/suite.md` | SEEDED per-test doc for the `suite` CI-push-category test — one doc per declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI-push/test-deploy.md` | SEEDED per-test doc for the `test-deploy` CI-push-category test — one doc per declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI-push/windows.md` | SEEDED per-test doc for the `windows` CI-push-category test — one doc per declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI-nightly/windows-deploy.md` | SEEDED per-test doc for the `windows-deploy` CI-nightly-category test — one doc per declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
