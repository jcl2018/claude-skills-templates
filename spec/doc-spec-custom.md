...
| `docs/tests/CI/validate.md` | SEEDED per-test doc for the `validate` CI-category test — one doc per declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI/suite.md` | SEEDED per-test doc for the `suite` CI-category test — one doc per declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI/test-deploy.md` | SEEDED per-test doc for the `test-deploy` CI-category test — one doc per declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
| `docs/tests/CI/windows.md` | SEEDED per-test doc for the `windows` CI-category test — one doc per declared category test. Seeded by /CJ_test_audit from the categories: axis (idempotent; safe to edit). | Present; seeded by test-spec.sh --seed-docs; human-readable; no work-item IDs. |
